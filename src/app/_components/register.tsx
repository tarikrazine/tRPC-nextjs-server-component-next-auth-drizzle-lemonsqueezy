      ...
      <CardContent className="pb-0">
        <Form {...form}>
          <form className="space-y-8">
            <div className="flex-1 flex space-y-6 flex-col ">
              <FormField
              ...
              render={({ field }) => (
                <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4 shadow">
                  ...
                  <div className="space-y-1 leading-none">
                    ...
                    <FormDescription>
                      By signing up, you are creating a [tRPC-next] account, and
                      you agree to tRPC-next’s{" "}
                      <TermsDialog title="Terms and Conditions" context={terms}>
                        <span className="text-primary cursor-pointer">
                          Terms
                        </span>
                      </TermsDialog>{" "}
                      of Use and{" "}
                      <TermsDialog title="Privacy Policy" context={privacy}>
                        <span className="text-primary cursor-pointer">
                          Privacy Policy
                        </span>
                      </TermsDialog>
            ...
            >
              {isLoading.credential ? null : (<UserPlus2 className="mr-2" />)}
        ...
        >
          {isLoading.github ? null : (
            <svg
              ...
              viewBox="0 0 64 64"
              //fill={cn("#FFFFFF", theme !== "dark",  "black")}
              fill={
                isMounted
                  ? cn({
